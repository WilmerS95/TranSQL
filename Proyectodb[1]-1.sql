...
--('Sara', 'Isabel', 'Castillo', 'Ramírez', NULL, 'sara.castillo@example.com', 6),
...
--('Capacitación en ventas', GETDATE(), 9, 3),
--('Compra de insumos', GETDATE(), 10, 3),
--('Viaje a la planta', GETDATE(), 11, 3);
...
--(GETDATE(), 'Inspección antes de la entrega', 2, 9, 1, 1, 5000, NULL),
--(GETDATE(), 'Inspección después de la entrega', 2, 10, 1, 2, NULL, 5500);
